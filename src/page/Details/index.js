      ...
      data => {
        ...
        data.map((item, index) => {
          if (item.action && item.action.rawData) {
            dataList.push({
              key: index,
              id: item.action.rawData.block_num,
  ...
  render() {
    ...
    const columnsAction = [
      ...
      },
      {
        ...
        render: type => {
          let color =
            type === "transfer" || type === "extransfer" ? "red" : "green";
    ...
    return (
      <div className="accountsdetails">
          ...
          <div className="details">
            <h3>
              ...
              <span className="created">
                {intl.get("createat")} {util.formatDateTime(data.created)}
              </span>
            </h3>
          </div>
        ...
        <div className="origindata">
          ...
          <ReactJson src={this.state.data} collapsed={true} />
        </div>
